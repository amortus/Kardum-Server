...
export interface PlayerState {
    ...
    equipments: {
        [defenderId: string]: CardInstance;
    };
    mounts: CardInstance[];
...
export interface SocketEvents {
    ...
    'mmo:players:snapshot': (data: {
        zone: string;
        zoneKey?: string;
        players: WorldPlayerState[];
    }) => void;
    'mmo:player:update': (data: {
        player: WorldPlayerState;
    }) => void;
    'mmo:player:leave': (data: {
        userId: number;
        zone: string;
        zoneKey?: string;
    }) => void;
    'mmo:monsters:snapshot': (data: {
        zone: string;
        monsters: MonsterRuntimeState[];
    }) => void;
    'mmo:monster:update': (data: {
        monster: MonsterRuntimeState;
    }) => void;
    'mmo:monster:despawn': (data: {
        spawnUid: string;
        zone: string;
        respawnAt: number;
    }) => void;
    'mmo:monster:engage': (data: {
        spawnUid: string;
        zone: string;
    }) => void;
    'mmo:encounter:start': (data: {
        matchId: number;
        spawnUid: string;
        zone: string;
    }) => void;
    'mmo:command:spawn': (data: {
        name: string;
        zone: string;
        x: number;
        y: number;
