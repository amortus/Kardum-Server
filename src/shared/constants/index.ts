...
export {
  ...
  LEVEL_CUMULATIVE_MIN_EXP,
  expRequiredToAdvanceFromLevel,
  totalExpRequiredForLevel
...
export const GAME_CONSTANTS = {
  ...
  /** Máximo de criaturas (defensores/montarias como criatura) no campo */
...
export const SOCKET_EVENTS = {
  ...
  MMO_COMMAND_4SPAWN: 'mmo:command:4spawn',
  MMO_COMMAND_SPAWNPOINT: 'mmo:command:spawnpoint',
  MMO_COMMAND_DELREGION: 'mmo:command:delregion',
  MMO_REGIONS_LOAD: 'mmo:regions:load',
  ...
  MMO_PLAYER_SPAWN: 'mmo:player:spawn',
